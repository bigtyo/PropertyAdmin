...
<div class="container">
    ...
    <blockquote>
        <p>Drag and Drop file, atau pilih file dengan menekan tombol dibawah<br>
    ...
    <form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="listingid" value="<?php echo $listingid; ?>" id="listingid" />
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <ul>
                <li>Ukuran File Maksimum adalah <strong>200 KB</strong>.</li>
                <li>Hanya file bertipe (<strong>JPG, GIF, PNG</strong>) yang dapat diupload.</li>
