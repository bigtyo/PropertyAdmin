							...
							<div class="box-content nopadding">
								<form action="#" method="POST" class="form-horizontal form-striped">
									...
									<div class="control-group">
										...
										<label for="textfield" class="control-label">Status</label>
                                                                                <div class="controls">
										<label for="textfield" class="control-label">Verified</label>
                                                                                </div>
										...
										<label for="textfield" class="control-label">Tipe Listing</label>
										<div class="controls">
											<label for="textfield" class="control-label">Exclusive</label>
										</div>
									</div>
                                                                        <div class="control-group">
										<label for="textfield" class="control-label">Kontak Agen</label>
										<div class="controls">
                                                                                        <label for="textfield" class="control-label">Raywhite Diponegoro</label>
											<label for="textfield" class="control-label">Yudhi</label>
                                                                                        <label for="textfield" class="control-label"><span class="label label-satgreen">Exclusive</span></label>
										</div>
									</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="t1">
											...
											<form action="#" method="POST" class="form-horizontal form-striped">
                                                                                            ...
                                                                                            <div class="control-group">
                                                                                                    <label for="textfield" class="control-label">Tingkat</label>
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">2</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                            <div class="control-group">
                                                                                                    <label for="textfield" class="control-label">Info lain</label>
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">Rumah menghadap timur</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                        </form>
										</div>
										<div class="tab-pane" id="t2">
											...
											<form action="#" method="POST" class="form-horizontal form-striped">
                                                                                            <div class="control-group">
                                                                                                    ...
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">Jl. Sutorejo Selatan 2/14 Mulyosari</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                            <div class="control-group">
                                                                                                    <label for="textfield" class="control-label">Lokasi :</label>
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">Komplek Sutorejo Indah, belakang giant</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                            <div class="control-group">
                                                                                                    <label for="textfield" class="control-label">Wilayah</label>
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">Surabaya Timur</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                            <div class="span12">
                                                                                                    <div class="box">
										...
										<div class="tab-pane" id="t3">
											...
											<form action="#" method="POST" class="form-horizontal form-striped">
                                                                                            <div class="control-group">
                                                                                                    ...
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">Bambang Budi</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                            <div class="control-group">
                                                                                                    <label for="textfield" class="control-label">Alamat :</label>
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">Jl. Ngemplak Timur 213</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                            <div class="control-group">
                                                                                                    <label for="textfield" class="control-label">Kontak</label>
                                                                                                    <div class="controls">
                                                                                                            <label for="textfield" class="control-label">08562122233</label>
                                                                                                    </div>
                                                                                            </div>
                                                                                        </form>
										</div>
